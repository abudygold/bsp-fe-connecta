...
import { CHANNEL_INSTAGRAM_TABLE } from '../../../../../shared/config/table';
...
@Component({
  ...
  styleUrl: './instagram-list.css',
})
export class InstagramList {
  #router = inject(Router);
  #activatedRoute = inject(ActivatedRoute);
  #api = inject(API);

  tableModel: TableModel = CHANNEL_INSTAGRAM_TABLE;
  searchControl = '';
