...
import { CHANNEL_FACEBOOK_TABLE } from '../../../../../shared/config/table';
import { TableModel } from '../../../../../shared/model';

@Component({
  selector: 'app-facebook-list',
  imports: [MatCheckboxModule, MatIconModule, Table],
  templateUrl: './facebook-list.html',
  styleUrl: './facebook-list.css',
})
export class FacebookList {
  #router = inject(Router);
  #activatedRoute = inject(ActivatedRoute);
  #api = inject(API);

  tableModel: TableModel = CHANNEL_FACEBOOK_TABLE;
  searchControl = '';
