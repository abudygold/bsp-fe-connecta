...
import { BROADCAST_TABLE } from '../../../../shared/config/table';
...
export class BroadcastList {
  ...
  tableModel: TableModel = BROADCAST_TABLE;
  searchControl = '';

  button = {
    addNewBroadcast: signal<ButtonModel>(
      CREATE_BUTTON('Add New Broadcast', 'flat', false, '', '', 'add'),
    ),
  };
